        ...
        prototype: {
            init: function(refresh) {
                ...
                if (!refresh) {
                    ...
                    this.$root
                        ...
                        .attr('data-menus-id', this.rootId)
                        .dataSM('level', 1)
                        .bind(getEventsNS([
                    ...
                    this.$root.find('a').each(function() {
                        ...
                        if (href == locHref || href == locHrefNoHash) {
                            ...
                            if (self.opts.markCurrentTree) {
                                $this.parent().parentsUntil('[data-menus-id]', 'li').children('a').addClass('current');
                            }
                        }
                    });
                }
            ...
            itemActivate: function($a) {
                ...
                if (level > 1 && (!this.activatedItems[level - 2] || this.activatedItems[level - 2][0] != $ul.dataSM('parent-a')[0])) {
                    var self = this;
                    $($ul.parentsUntil('[data-menus-id]', 'ul').get().reverse()).add($ul).each(function() {
